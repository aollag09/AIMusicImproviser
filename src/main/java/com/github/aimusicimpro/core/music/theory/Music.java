...
public class Music {
    ...
    public static final Map<Integer, String> MidiToNotes;
    /**
    ...
    static {
        Map<Integer, String> tempNotes = new HashMap<>();
        tempNotes.put(0, "C");
        tempNotes.put(1, "D" + FLAT);
        tempNotes.put(2, "D");
        tempNotes.put(3, "E" + FLAT);
        tempNotes.put(4, "E");
        tempNotes.put(5, "F");
        tempNotes.put(6, "F" + SHARP);
        tempNotes.put(7, "G");
        tempNotes.put(8, "G" + SHARP);
        tempNotes.put(9, "A");
        tempNotes.put(10, "B" + FLAT);
        tempNotes.put(11, "B");
        MidiToNotes = Collections.unmodifiableMap(tempNotes);
    }
    ...
    static {
        ...
        tempAlterations.put("major",
                new String[]{"C", "D" + FLAT, "D", "E" + FLAT, "E", "F", "F" + SHARP, "G", "A" + FLAT, "A", "B" + FLAT,
                        "B"});
        tempAlterations.put("minor",
                new String[]{"C", "C" + SHARP, "D", "D" + SHARP, "E", "F", "F" + SHARP, "G", "G" + SHARP, "A",
                        "B" + FLAT, "B"});
        tempAlterations.put("dorian",
                new String[]{"C", "C" + SHARP, "D", "E" + FLAT, "E", "F", "F" + SHARP, "G", "G" + SHARP, "A",
                        "B" + FLAT, "B"});
        tempAlterations.put("phrygian",
                new String[]{"C", "C" + SHARP, "D", "D" + SHARP, "E", "F", "F" + SHARP, "G", "G" + SHARP, "A",
                        "A" + SHARP, "B"});
        tempAlterations.put("lydian",
                new String[]{"C", "D" + FLAT, "D", "E" + FLAT, "E", "F", "G" + FLAT, "G", "A" + FLAT, "A", "B" + FLAT,
                        "B"});
        tempAlterations.put("mixolydian",
                new String[]{"C", "C" + SHARP, "D", "E" + FLAT, "E", "F", "F" + SHARP, "G", "A" + FLAT, "A", "B" + FLAT,
                        "B"});
        tempAlterations.put("locrian",
                new String[]{"C", "C" + SHARP, "D", "D" + SHARP, "E", "E" + SHARP, "F" + SHARP, "G", "G" + SHARP, "A",
                        "A" + SHARP, "B"});
    ...
    static {
        ...
        tempCircle.put("major",
                new String[]{"C", "G", "D", "A", "E", "B", "F" + SHARP, "D" + FLAT, "A" + FLAT, "E" + FLAT, "B" + FLAT,
                        "F"});
        tempCircle.put("minor",
                new String[]{"A", "E", "B", "F" + SHARP, "C" + SHARP, "G" + SHARP, "D" + SHARP, "B" + FLAT, "F", "C",
                        "G", "D"});
