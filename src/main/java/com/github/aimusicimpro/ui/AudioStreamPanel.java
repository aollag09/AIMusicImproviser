...
public class AudioStreamPanel extends JPanel {
  ...
  class AudioStreamDrawComponent extends JComponent implements ComponentListener {
    ...
    public void draw( float[] iAudio ) {
      ...
      //System.out.println( Arrays.toString( iAudio ) );
      ...
      for(int i = 0; i< mspeed; i ++ ) {
        ...
        System.out.println( " AMPL : " + amplint );
